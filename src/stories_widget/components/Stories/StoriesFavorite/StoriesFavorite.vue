  ...
  <StoryCardsWrapper class="container" :style="rootVars">
    <div class="header">
      ...
      <button class="stories-favorite__close"
        ...
        <span><CloseIcon height="25px"/></span></button>
    </div>
...
import {STORY_LIST_TYPE, STORY_READER_WINDOW_REFERER} from '../../../../story-manager/common.h';
import CloseIcon from "../../svg/CloseIcon.vue";

const StoriesFavorite = Vue.extend({
  name: "StoriesFavorite",
  components: {StoryCardItem, StoryCardsWrapper, CloseIcon},
    ...
    rootVars() {
      return {
        ...
        "--card-gap": this.storiesGap + 'px',
          '--storiesFavoriteTitleColor': this.favoriteOptions.title.color,
          '--storiesFavoriteTitleFontFamily': 'InternalPrimaryFont',
          '--storiesFavoriteTitleFont': this.favoriteOptions.title.font,
