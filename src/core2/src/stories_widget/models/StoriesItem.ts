...
import {replaceAll} from "~/src/stories_widget/util/string";
...
export default class StoriesItem extends AbstractModel {
    ...
    public sharePath!: Nullable<string>;
    public like_functional!: Nullable<boolean>;
    public favorite_functional!: Nullable<boolean>;
    public share_functional!: Nullable<boolean>;
    public need_placeholders: Nullable<boolean> = null;

    public tags!: Array<string>;
    public has_audio!: Nullable<boolean>;
    public has_placeholder!: Nullable<boolean>;
    public has_swipe_up!: Nullable<boolean>;
    ...
    public _video_cover: Nullable<ImageSet> = null;
    ...
    public static fetchList(placeholders: Dict, tags: Nullable<string>, favorite?: boolean): Promise<IDataProvider<StoriesItem>> {
        this.placeholders = placeholders;
        const params: {tags: Nullable<string>, favorite?: number} = {tags};
    ...
    public static fetchOnboardingList(placeholders: Dict, tags: Nullable<string>): Promise<IDataProvider<StoriesItem>> {
        this.placeholders = placeholders;
    ...
    public attributes(): Array<string> {
        return concat(super.attributes(), [
          ...
          'slidesLoaded' // special for rawData from manager
        ]);
    }
    ...
    public get imageSrc(): Nullable<string> {
    ...
    public imagePerSlide(index: number): Nullable<string> {
    ...
    public set video_cover(value: Nullable<ImageSet>) {
        if (value !== null) {
            this._video_cover = ImageSet.createFromArray(value);
        }
    }

    public get video_cover(): Nullable<ImageSet> {
        return this._video_cover;
    }

    public get videoCoverSrc(): Nullable<string> {
        if (this._videoCoverSrc === false) {
            ...
            const video: Nullable<Image> = videoCoverSet.findOneByType('h');
            if (video !== null) {
                return video.url;
            }
        }
    ...
    // переделать -- брать и ставить isOpened из менеджера (там будет RN store)
    get isOpened(): boolean
    {
        // if (!isEmpty(Session.userKey)) {
        //     const key = `u/${Session.userKey}/s_opened`;
        //     let data: Nullable<Array<number>> = localStorageGet(key);
        //     if (!isArray(data)) {
        //         data = [];
        //     }
